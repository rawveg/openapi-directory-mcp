...
export const createMockCacheManager = () => ({
  ...
  getStats: jest
    .fn()
    .mockReturnValue({ keys: 0, hits: 0, misses: 0, ksize: 0, vsize: 0 }),
  ...
  getConfig: jest
    .fn()
    .mockReturnValue({ enabled: true, ttlSeconds: 1, maxKeys: 1000 }),
});
